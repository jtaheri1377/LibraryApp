...
export class SubjectService {
  subjectsUpdate$: BehaviorSubject<BookSubject | null> = new BehaviorSubject<BookSubject | null>(
    null
  );
  ...
  generateCode(): Observable<HttpResponse<string>> {
    return this.http.get<string>(`${environment.ApiEndpoint}Book/newSubject`, {
      observe: "response",
    });
  }
